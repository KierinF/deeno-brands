...
export default function DashboardClient({ client, stats, meetings }: Props) {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#F7F4EE" }}>
      {/* Top bar */}
      <div style={{ background: "#1C2B2B", padding: "16px 40px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <a href="/" style={{ textDecoration: "none" }}>
          <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 24, letterSpacing: "3px", color: "#E8A020" }}>DEENO</span>
        </a>
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <button
            ...
            style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "1.5px", padding: "8px 16px", background: "transparent", color: "rgba(247,244,238,0.5)", border: "1px solid rgba(247,244,238,0.15)", cursor: "pointer", transition: "color 0.2s, border-color 0.2s" }}
            onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.color = "#F7F4EE"; (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(247,244,238,0.4)"; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.color = "rgba(247,244,238,0.5)"; (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(247,244,238,0.15)"; }}
          >
            SIGN OUT
          </button>
        </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 40px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "center" }}>
            ...
            <span style={{ color: "#C8C1B3" }}>·</span>
            <span style={{
              fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "1px", padding: "2px 8px",
        ...
        {/* Summary stats */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 1, background: "#C8C1B3", border: "1px solid #C8C1B3", marginBottom: 40 }}>
          {[
            ...
            <div key={s.label} style={{ background: "#F7F4EE", padding: "28px 24px" }}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 48, color: s.highlight ? "#E8A020" : "#1C2B2B", lineHeight: 1, marginBottom: 4 }}>
                {s.value}
              </div>
                ...
                <div key={week.week_number} style={{ background: "#EEE9DF", padding: "20px 24px", display: "grid", gridTemplateColumns: "100px 1fr", gap: "0 24px", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
                    {[
                      ...
                      { label: "Reply Rate", value: `${week.email_reply_rate}%` },
                      ...
                      <div key={d.label}>
                        <div style={{ fontSize: 18, fontWeight: 600, color: (d as {highlight?: boolean}).highlight ? "#E8A020" : "#1C2B2B" }}>{d.value}</div>
              ...
              {meetings.map((m) => (
                <div key={m.id} style={{ background: "#F7F4EE", padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                    ...
                    <span style={{
                      fontFamily: "'DM Mono', monospace", fontSize: 9, letterSpacing: "1px", textTransform: "uppercase", padding: "3px 8px",
        ...
        {stats.length === 0 && meetings.length === 0 && (
          <div style={{ background: "#EEE9DF", border: "1px solid #C8C1B3", borderLeft: "3px solid #E8A020", padding: "40px", textAlign: "center" }}>
